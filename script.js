...
function DarkMode(){
  document.getElementById("BtnDarkMode").style.backgroundColor = 'rgba(0, 0, 0, 0.55)';
...
function LightMode(){
  document.getElementById("BtnLightMode").style.backgroundColor = 'rgba(255, 255, 255, 0.25)';
